...
public class Common {
    ...
    public static ArrayList<HistoryRequest> addAlphabeta(ArrayList<HistoryRequest> list){
        int i = 0;
        ArrayList<HistoryRequest> customList = new ArrayList<>();
        HistoryRequest firstPosition = new HistoryRequest("Driver Accepted", new Date(), "gg", "gg", 1, VIEWTYPE_GROUP);
    ...
    public static ArrayList<HistoryRequest> sortList(ArrayList<HistoryRequest> historyRequests){
